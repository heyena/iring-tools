  ...
  class Program
  {
    static void Main(string[] args)
    {
      ...
      { 
        ...
        new Scenario{scenarioName = "Bechtel (Inspec) -> Dow (SSPID) [Equipment]", sender="Bechtel", receiver="Dow", 
          senderAdapterServiceId = "2", receiverAdapterServiceId = "27", interfaceServiceId = "2",
          senderProjectName="12345_000", senderApplicationName="Inspec", senderGraphName="EquipmentList",
          receiverProjectName="12345_000", receiverApplicationName="SSPID", receiverGraphName="Equipment",
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "CCC (C3D) -> Bechtel (Inspec) [Equipment]", sender="CCC", receiver="Bechtel", 
          senderAdapterServiceId = "3", receiverAdapterServiceId = "2", interfaceServiceId = "3",
          senderProjectName="CCC", senderApplicationName="C3D", senderGraphName="Equipment",
        ...
        new Scenario{scenarioName = "ExxonMobile (API) -> Bechtel (Inspec) [Equipment]", sender="ExxonMobile", receiver="Bechtel", 
          ...
          receiverProjectName="12345_000", receiverApplicationName="Inspec", receiverGraphName="EquipmentList",
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "Bechtel (Inspec) -> Dow (SSPID) [Instrument]", sender="Bechtel", receiver="Dow", 
          senderAdapterServiceId = "2", receiverAdapterServiceId = "27", interfaceServiceId = "2",
          senderProjectName="12345_000", senderApplicationName="Inspec", senderGraphName="InstrumentList",
          receiverProjectName="12345_000", receiverApplicationName="SSPID", receiverGraphName="Instruments",
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "Emerson (EIO) -> Bechtel (Inspec) [Instrument]", sender="Emerson", receiver="Bechtel", 
          ...
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "Bechtel (Inspec) -> CCC (C3D) [PipingNetworkSystem]", sender="Bechtel", receiver="CCC", 
          senderAdapterServiceId = "2", receiverAdapterServiceId = "3", interfaceServiceId = "2",
          ...
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "Bechtel (Inspec) -> Dow (SSPID) [PipingNetworkSystem]", sender="Bechtel", receiver="Dow", 
          senderAdapterServiceId = "2", receiverAdapterServiceId = "27", interfaceServiceId = "2",
          senderProjectName="12345_000", senderApplicationName="Inspec", senderGraphName="LineList",
          receiverProjectName="12345_000", receiverApplicationName="SSPID", receiverGraphName="Lines",
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "Bentley (PDx) -> Bechtel (Inspec) [PipingNetworkSystem]", sender="Bentley", receiver="Bechtel", 
          senderAdapterServiceId = "N/A", receiverAdapterServiceId = "2", interfaceServiceId = "6",
          senderProjectName="12345_000", senderApplicationName="PDx", senderGraphName="N/A",
          receiverProjectName="12345_000", receiverApplicationName="Inspec", receiverGraphName="LineList",
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "CCC (C3D) -> Bechtel (Inspec) [PipingNetworkSystem]", sender="CCC", receiver="Bechtel", 
          senderAdapterServiceId = "3", receiverAdapterServiceId = "2", interfaceServiceId = "3",
