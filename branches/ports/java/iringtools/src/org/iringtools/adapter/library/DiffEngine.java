...
public class DiffEngine
{
  ...
  private List<TemplateObject> getTemplateObjectList(List<OMElement> owlThings, String classInstance,
      TemplateMap templateMap) throws Exception
  {
  ...
  // TODO: validate sendingRdf for required fields
      ...
      for (int sendingClassInstanceIndex = 0; sendingClassInstanceIndex < sendingClassInstances.size(); sendingClassInstanceIndex++)
      {
        ...
        for (int receivingClassInstanceIndex = 0; receivingClassInstanceIndex < receivingClassInstances.size(); receivingClassInstanceIndex++)
        {
          ...
          if (sendingClassInstance.equalsIgnoreCase(receivingClassInstance))
          {
            ...
            {
              List<TemplateObject> sendingTemplateObjectList = getTemplateObjectList(sendingOwlThings,
                  sendingClassInstance, templateMap);
              List<TemplateObject> receivingTemplateObjectList = getTemplateObjectList(receivingOwlThings,
                  sendingClassInstance, templateMap);
