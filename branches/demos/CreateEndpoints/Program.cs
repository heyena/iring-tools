    ...
    static void Main(string[] args)
    {
      ...
      Scenarios scenarios = new Scenarios
      {
        ...
        new Scenario{scenarioName = "ExxonMobile (API) -> Bechtel (Inspec) [Equipment]", sender="ExxonMobile", receiver="Bechtel", 
          ...
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "Bechtel (Inspec) -> CCC (C3D) [Lines]", sender="Bechtel", receiver="CCC", 
          ...
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "Emerson (EIO) -> Debug (Inspec) [Instruments]", sender="Emerson", receiver="Bechtel", 
          senderAdapterServiceId = "5", receiverAdapterServiceId = "90", interfaceServiceId = "5",
          senderProjectName="12345_000", senderApplicationName="EIO", senderGraphName="INSTRUMENTS",
          receiverProjectName="12345_000", receiverApplicationName="Inspec", receiverGraphName="InstrumentList",
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "Bentley (PDx) -> Debug (Inspec) [Lines]", sender="Bentley", receiver="Bechtel", 
          senderAdapterServiceId = "N/A", receiverAdapterServiceId = "90", interfaceServiceId = "1",
          senderProjectName="12345_000", senderApplicationName="PDx", senderGraphName="",
          receiverProjectName="12345_000", receiverApplicationName="Inspec", receiverGraphName="LineList",
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "ExxonMobile (API) -> Debug (Inspec) [Equipment]", sender="ExxonMobile", receiver="Bechtel", 
          senderAdapterServiceId = "1", receiverAdapterServiceId = "90", interfaceServiceId = "1",
          senderProjectName="12345_000", senderApplicationName="API", senderGraphName="Equipment",
          receiverProjectName="12345_000", receiverApplicationName="Inspec", receiverGraphName="EquipmentList",
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "Bechtel (Inspec) -> Debug (C3D) [Lines]", sender="Bechtel", receiver="CCC", 
          senderAdapterServiceId = "2", receiverAdapterServiceId = "90", interfaceServiceId = "2",
          senderProjectName="12345_000", senderApplicationName="Inspec", senderGraphName="LineList",
          receiverProjectName="CCC", receiverApplicationName="C3D", receiverGraphName="Lines",
          exportEnabled=false, importEnabled=false},
        new Scenario{scenarioName = "Bechtel (Inspec) -> Debug (SPPID) [Lines]", sender="Bechtel", receiver="Dow", 
          senderAdapterServiceId = "2", receiverAdapterServiceId = "90", interfaceServiceId = "2",
          senderProjectName="12345_000", senderApplicationName="Inspec", senderGraphName="Lines",
          receiverProjectName="CrackingComplex", receiverApplicationName="SPPID", receiverGraphName="LINE",
          exportEnabled=false, importEnabled=false},
      };
