...
namespace iRINGTools.SDK.SpreadsheetDataLayer
{
  public class SpreadsheetProvider
  {
    ...
    private List<SpreadsheetColumn> GetColumns(SpreadsheetTable table)
    {
    ...
    private SpreadsheetConfiguration ProcessConfiguration(SpreadsheetConfiguration configuration)
    {
