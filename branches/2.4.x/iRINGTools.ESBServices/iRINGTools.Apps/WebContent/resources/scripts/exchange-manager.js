...
function deleteApp(node, event) {
  ...
  Ext.Msg.show({
    ...
    msg: '<textarea ' + style + ' readonly="yes">' + 'Are you sure to delete ' + appName + ' application?'
        + '</textarea>',
...
function deleteCommodity(node, event) {
  ...
  Ext.Msg.show({
    ...
    msg: '<textarea ' + style + ' readonly="yes">' + 'Are you sure to delete ' + commName + ' commodity?'
        + '</textarea>',
    buttons: Ext.MessageBox.YESNO,
    modal: true,
    // icon: Ext.Msg.QUESTION,
...
function deleteConfig() {
  ...
  Ext.Msg.show({
    ...
    msg: '<textarea ' + style + ' readonly="yes">' + 'Are you sure to delete ' + '"' + exchangeConfigName + '"'
        + ' exchange?' + '</textarea>',
    buttons: Ext.MessageBox.YESNO,
    modal: true,
    // icon: Ext.Msg.QUESTION,
