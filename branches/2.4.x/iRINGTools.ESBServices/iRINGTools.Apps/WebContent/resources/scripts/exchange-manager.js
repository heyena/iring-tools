					...
					Ext.Ajax
							.request({
								...
								success : function(response, request) {
									...
									if (result === 'cache') {
										graphSubMenu.items.items[2]
												.setDisabled(false);
										graphSubMenu.items.items[4]
												.setDisabled(false);
										graphSubMenu.items.items[3]
												.setDisabled(false);
