        ...
        if (type == 'exchange') {
          var dtoToolbar = new Ext.Toolbar({
            ...
            items : [ {
              ...
              id : 'tb-dup',
              xtype : 'button',
              tooltip : 'Show Pre-Exchange Summary',
...
function deleteApp(node, event) {
  ...
  Ext.Msg.show({
    ...
    msg : '<textarea ' + style + ' readonly="yes">' + 'Are you sure you want to delete ' + appName + ' application?'
        + '</textarea>',
...
function deleteGraph(node, event) {
  ...
  Ext.Msg.show({
    title : 'Delete Graph',
    msg : '<textarea ' + style + ' readonly="yes">' + 'Are you sure you want to delete ' + name + ' graph?'
        + '</textarea>',
    buttons : Ext.MessageBox.YESNO,
    modal : true,
    fn : function(buttonId, text) {
...
function deleteCommodity(node, event) {
  ...
  Ext.Msg.show({
    ...
    msg : '<textarea ' + style + ' readonly="yes">' + 'Are you sure you want to delete ' + commName + ' commodity?'
        + '</textarea>',
    buttons : Ext.MessageBox.YESNO,
    modal : true,
    fn : function(buttonId, text) {
...
function deleteConfig() {
  ...
  Ext.Msg.show({
    ...
    msg : '<textarea ' + style + ' readonly="yes">' + 'Are you sure you want to delete ' + '"' + exchangeConfigName
        + '"' + ' exchange?' + '</textarea>',
    buttons : Ext.MessageBox.YESNO,
    modal : true,
    // icon: Ext.Msg.QUESTION,
...
function buildNewExchangeMenu() {
  return [ {
    ...
    handler : function(item, event) {
      ...
      Ext.getCmp('sourceGraphCombolist').setDisabled(true);

      Ext.getCmp('targetScopeCombolist').setDisabled(true);
      Ext.getCmp('targetAppCombolist').setDisabled(true);
      Ext.getCmp('targetGraphCombolist').setDisabled(true);
	      ...
	      items : [ {
	        ...
	        listeners : {
	          ...
	          render : function(c) {
	            c.getEl().on('keyup', function() {
	              ...
	              Ext.getCmp('sourceAppCombolist').setDisabled(true);
	              Ext.getCmp('sourceGraphCombolist').clearValue();
	              Ext.getCmp('sourceGraphCombolist').setDisabled(true);
	            }, c);
	          }
	        }
	        ...
	        listeners : {
	          ...
	          select : function() {
	            ...
	            var AppName = form.findField('sourceAppName').getValue();
	            var context = form.findField('sourceScopeName').getValue();
	            var Uri  = form.findField('sourceUri').getValue();
	            graphNameStore = new Ext.data.ArrayStore({

	            	url : 'getGraphNames?' + '&scope =' + context
	            			+ '&name =' + AppName + '&sourceUri ='
	            			+ Uri,
	            	autoDestroy : true,
	            	autoLoad : false,
	            	fields : [ {
	            ...
	            Ext.getCmp('sourceGraphCombolist').bindStore(graphNameStore);
	      ...
	      items : [ {
	        ...
	        listeners : {
	          ...
	          render : function(c) {
	            c.getEl().on('keyup', function() {
	              ...
	              Ext.getCmp('targetAppCombolist').setDisabled(true);
	              Ext.getCmp('targetGraphCombolist').clearValue();
	              Ext.getCmp('targetGraphCombolist').setDisabled(true);
	            }, c);
	          }
	        }
	        ...
	        listeners : {
	          ...
	          select : function() {
	            ...
	            var obj = Ext.getCmp('newExchConfig');
	            var form = obj.getForm();               
	            var AppName = form.findField('targetAppName').getValue();
	            var context = form.findField('targetScopeName').getValue();
	            var Uri  = form.findField('targetUri').getValue();
	            graphNameStore = new Ext.data.ArrayStore({
	            ...
	            Ext.getCmp('targetGraphCombolist').bindStore(graphNameStore);
...
function SourceUri() {
  ...
  Ext.Ajax.request({
    ...
    success : function(response, request) {
      ...
      Ext.Msg.show({
        title : 'Result ',
        msg : '<textarea ' + style + ' readonly="yes">' + result.message + '</textarea>',
...
function saveExchangeConfig() {
  ...
  if (((targetAppName !== "") && (targetAppName !== null)) && ((targetScopeName !== "") && (targetScopeName !== null))
      ...
      && ((sourceScopeName !== "") && (sourceScopeName !== null)) && ((sourceUri !== "") && (sourceUri !== null))
      && ((sourceGraphName !== "") && (sourceGraphName !== null)) && ((name !== "") && (name !== null))) {
...
function fillShowUpdateCache() {
  ...
  Ext.Ajax.request({
    url : 'getShowUpdateCache?' + '&scope =' + scope + '&appName =' + appNameValue + '&name =' + graphValue
        + '&baseUri =' + Uri,
    method : 'POST',
    timeout : 120000,
    success : function(response, request) {
...
function editGraph() {
	...
	var graphValue = node.text;
	var appNameValue = node.parentNode.attributes.properties['Internal Name'];
	var Uri = node.parentNode.attributes.properties['Base URI'];
	...
	Ext.Ajax.request({
		...
		success : function(response, request) {
			...
			var context = node.attributes.properties['Context'];
			 graphNameStore = new Ext.data.ArrayStore({

					url : 'getGraphNames?' + '&scope =' + context
							+ '&name =' + appNameValue + '&sourceUri ='
							+ Uri,
					autoDestroy : true,
					autoLoad : false,
					fields : [ {
			  ...
			  Ext.getCmp('graphCombolist').bindStore(graphNameStore);
...
function newGraph() {
	 ...
	 var obj = Ext.getCmp('directory-tree')
		.getSelectionModel().getSelectedNode();
var AppName = obj.attributes.properties['Internal Name'];
var context = obj.attributes.properties['Context'];
var Uri = obj.attributes.properties['Base URI'];

var graphNameStore = new Ext.data.ArrayStore({
  ...
  Ext.Ajax.request({
    ...
    success : function(response, request) {
      ...
      if (result === 'ERROR') {
        ...
        var message = 'Graph name ' + '"' + graph + '"' + ' already exists in scope ' + '["' + oldScope + '.' + oldapp
            + '"]' + '.';
  ...
  Ext.Ajax.request({
    ...
    success : function(response, request) {
      ...
      AppNameStore = new Ext.data.ArrayStore({
        ...
        url : 'getAppNames?' + '&appScope =' + application.context + '&sourceUri =' + application.baseUri,
        autoDestroy : true,
        autoLoad : false,
        fields : [ {
          name : 'value'
	  ...
	  Ext.Ajax.request({
	    ...
	    success : function(response, request) {
	      ...
	      AppNameStore = new Ext.data.ArrayStore({
	        ...
	        url : 'getAppNames?' + '&appScope =' + form.sourceScope + '&sourceUri =' + form.sourceUri,
	        autoDestroy : true,
	        autoLoad : false,
	        fields : [ {
	          name : 'value'
	      ...
	      Ext.getCmp('sourceAppCombolist').setValue(form.sourceApp);
	       graphNameStore = new Ext.data.ArrayStore({
	    		...
	    		url : 'getGraphNames?' + '&scope =' + form.sourceScope
	    				+ '&name =' + form.sourceApp + '&sourceUri ='
	    				+ form.sourceUri,
	    		autoDestroy : true,
	    		autoLoad : false,
	    		fields : [ {
	       ...
	       Ext.getCmp('sourceGraphCombolist').bindStore(graphNameStore);
	       Ext.getCmp('sourceGraphCombolist').setValue(form.sourceGraph);
	      ...
	      AppNameStore = new Ext.data.ArrayStore({
	        ...
	        url : 'getAppNames?' + '&appScope =' + form.targetScope + '&sourceUri =' + form.targetUri,
	        autoDestroy : true,
	        autoLoad : false,
	        fields : [ {
	          name : 'value'
	     ...
	     graphNameStore = new Ext.data.ArrayStore({
	      	...
	      	url : 'getGraphNames?' + '&scope =' + form.targetScope
	      			+ '&name =' + form.targetApp + '&sourceUri ='
	      			+ form.targetScope,
	      	autoDestroy : true,
	      	autoLoad : false,
	      	fields : [ {
	     ...
	     Ext.getCmp('targetGraphCombolist').bindStore(graphNameStore);
	     Ext.getCmp('targetGraphCombolist').setValue(form.targetGraph);
...
function saveScope(node, button, event) {
  ...
  Ext.Ajax.request({
    ...
    success : function(response, request) {
      var result = Ext.decode(response.responseText);
      if (result === 'ERROR') {
        var message = 'Scope name ' + '"' + scope + '"' + ' already exists' + '.';
        +response.responseText;
        showDialog(400, 90, 'Error', message, Ext.Msg.OK, null);
  ...
  Ext.Ajax
      .request({
        ...
        success : function(response, request) {
          var result = Ext.decode(response.responseText);
          if (result === 'ERROR') {
            var message = 'Commodity name ' + '"' + commodity + '"' + ' already exists in scope ' + '"' + scope + '"'
                + '.';
            +response.responseText;
            showDialog(400, 90, 'Error', message, Ext.Msg.OK, null);
...
function getAppNames(name) {
  ...
  AppNameStore = new Ext.data.ArrayStore({
    ...
    url : 'getAppNames?' + '&appScope =' + scopeName + '&sourceUri =' + baseUri,
    autoDestroy : true,
    autoLoad : false,
    fields : [ {
      name : 'value'
  ...
  var newAppForm = new Ext.FormPanel({
     ...
     */{
      ...
      listeners : {
        scope : this,
        select : function() {
          var appName = Ext.getCmp('appCombolist').getValue();
          var obj = Ext.getCmp('newAppForm');
          var form = obj.getForm();
          form.findField('displayName').setDisabled(false);
          form.findField('appDesc').setDisabled(false);
          form.findField('displayName').setValue(appName);
        }
...
function saveApp(node, button, event) {
  ...
  if (((baseUri !== "") && (baseUri !== null)) && ((scopeName !== "") && (scopeName !== null))
    ...
    Ext.Ajax.request({
      ...
      success : function(response, request) {
        ...
        if (result === 'ERROR') {
          ...
          var message = 'Application name ' + '"' + application + '"' + ' already exists in scope ' + '"' + oldScope
              + '"' + '.';
          +response.responseText;
          showDialog(400, 90, 'Error', message, Ext.Msg.OK, null);
    ...
    if (scopeName === "") {
      form1.findField('scopeCombolist').markInvalid('Scope cannot be Empty');

    }
    if (appName === "") {
      form1.findField('appCombolist').markInvalid('App Name cannot be Empty');
    }
    if (appDisplay === "") {
      form1.findField('displayName').markInvalid('Dispaly App Name cannot be Empty');
    }
  }
}
    ...
    items : [ {
      ...
      items : [ {
        ...
        items : [ {
          ...
          xtype : 'button',
          handler : function(button, event) {
            var fieldSet = Ext.getCmp('Expressions');
              ...
              // '5',
                ...
                handler : function(button, event) {
                  ...
                  for ( var i = curID; i <= rowCount - 1; i++) {
                    ...
                    Ext.getCmp('dataFilter_' + i).destroy();
                  ...
                  for ( var j = curID + 1; j <= rowCount - 1; j++) {
                    ...
                    Ext.getCmp('openCount_' + (j - 1)).setValue(arrOpen[j]);

                    Ext.getCmp('propertyName_' + (j - 1)).setValue(arrProName[j]);
                    Ext.getCmp('relationalOperator_' + (j - 1)).setValue(arrRelaOper[j]);
                    Ext.getCmp('value_' + (j - 1)).setValue(arrValue[j]);
                    Ext.getCmp('logicalOperator_' + (j - 1)).setValue(arrLogOper[j]);
                    Ext.getCmp('closeGroup_' + (j - 1)).setValue(arrClose[j]);
          ...
          handler : function(button, event) {
            ...
            var newrow = {
...

              {
                ...
                xtype : 'button',
                handler : function(button, event) {
                  var container = this.findParentByType('fieldset');
                  // container.el.mask('Deleting
                  // Order
                  // Expression
                  // ....');
                  ...
                  for ( var i = curID; i <= rowCount - 1; i++) {
                    ...
                    var sort = Ext.getCmp('OESortOrder_' + i).getValue();
                ...
                try {
                  ...
                  if (dataTypeNode != null) {
                    if (dataTypeNode.attributes['text'] == 'Application Data') {
                      ...
                      node.reviewed = true;
                      loadPageDto('exchange', 'xdata', context, label);
                    }
                  }
                } catch (err) {
                }
