...
public class LdapEndpoint implements DirContext
{
  String name, description, type, context, baseUrl, assembly, member;
  Attributes myAttrs = new BasicAttributes(true);
  Attribute oc = new BasicAttribute("objectClass");

  public LdapEndpoint(String name, String description, String type, String context, String baseUrl, String assembly, String member)
  {
    this.name = name;
    this.type = type;
