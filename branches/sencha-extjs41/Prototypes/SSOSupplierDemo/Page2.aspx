<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page2.aspx.cs" Inherits="SSOSupplierDemo.Page2" %>
...
<title>Supplier Portal SSO Demo</title>
</head>
<body>
...
<div id="wrap">
	...
	<div  id="nav">
		<ul>
			...
			<li id="current"><a href="Page2.aspx">Archives</a></li>
    ...
    <h3><asp:Label ID="lblInfo" runat="server" Text=""></asp:Label></h3>
        ...
        Using Ajax: <input id="go" type="button" value="Call Service"  />
        Response: <input type="text" id="saythis" /> 
            <br />
            
            Using Server Side: <asp:Button ID="btnCallService" runat="server" onclick="btnCallService_Click" 
                Text="Call Service" />
            <asp:TextBox ID="txtServiceResponse" runat="server"></asp:TextBox>
            <br />
            
            <div id="ingest_history" />
        </form>
             ...
             $("#go").click(function() 
              {
                ...
                function getToken()
                {
                    ...
                    {
                         type: "GET",
                         url: "<%= ConfigurationManager.AppSettings["tokenServiceAddress"] %>/GetToken?username=<%=  userNameForJQuery%>",
                         contentType: "text/plain; charset=utf-8",
                         dataType: "json",
                         success: function(data) 
                         {
                            lToken = data;
                            $("#ingest_history").html(lToken);
                            getHello(lToken, word);
                ...
                function getHello(mToken, mWord)
                {
                    ...
                    $.ajax(
                    {
                        ...
                        {
                             req.setRequestHeader("From", mToken);
                         },
                         type: "GET",
                         url: "<%= ConfigurationManager.AppSettings["webServiceAddress"] %>/Hello?World=" + mWord,
                         contentType: "text/plain; charset=utf-8",
                         dataType: "text",
                         success: function(data) {
                             $("#ingest_history").html("The REST Service said: " + data);
                         }
                    });
                }
