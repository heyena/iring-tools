...
<head runat="server">
  ...
  <link rel="stylesheet" type="text/css" href="<%: Url.Content("~/Scripts/ext-4.2.1.883/ux/grid/css/RangeMenu.css") %>" /> 
  ...
  <script type="text/javascript" src="<%: Url.Content("~/Scripts/ext-4.2.1.883/ux/grid/CustomFiltersFeature.js") %>"></script>
  <script type="text/javascript" src="<%: Url.Content("~/Scripts/USM/USM.js") %>"></script>   
</head>
<body> 
</body>
</html>
