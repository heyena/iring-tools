	...
	public class DTOService : IDTOService
	{
		...
		public object CreateList(string graphName, string dtoListString)
		{
          ...
          LinesFile = Utility.RemoveNamespace(LinesFile);
					List<Lines> LinesList = new List<Lines>();          
          var Linesquery1 = from c in LinesFile.Elements("Envelope").Elements("Payload").Elements("DataTransferObject")
          select c;
          foreach (var dto in Linesquery1)
          {
						var Linesquery2 = from c in dto.Elements("Properties").Elements("Property")
						select c;
						Lines graphObject = new Lines();
						 foreach (var dtoProperty in Linesquery2)
						 {
