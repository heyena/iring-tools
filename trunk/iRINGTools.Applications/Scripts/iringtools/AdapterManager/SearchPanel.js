    ...
    if (searchText != '') {
      ...
      treeLoader.on("beforeload", function (treeLoader, node) {
        ...
        if (node.parentNode && node.attributes.identifier == null) {
          ...
          if (node.attributes.record != undefined && node.attributes.record.range != undefined) {
            treeLoader.baseParams.range = node.attributes.record.range;
          } else {
            treeLoader.baseParams.range = null;
          } 
        }
      }, this);
