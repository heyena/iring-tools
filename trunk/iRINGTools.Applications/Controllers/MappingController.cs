  ...
  public class MappingController : BaseController
  {
    ...
    public ActionResult GraphMap(FormCollection form)
    {
      ...
      try
      {
        ...
        bool qn = false;
        if (_nsMap.Prefixes.Contains(classId.Substring(0, 3)))
        {
          qName = classId;
        }
        else
        ...
        if (oldGraphName == "")
        {
          ...
          nodes.Add(GetGraphNode(graphMap, context, qName));
        }
        else
        {
    ...
    public ActionResult valueListMap(FormCollection form)
    {
      try
      {
        ...
        string classLabel = form["classlabel"];
        if (_nsMap.Prefixes.Contains(classUrl.Substring(0, 3)))
        {
          qName = classUrl;
        }
        else
