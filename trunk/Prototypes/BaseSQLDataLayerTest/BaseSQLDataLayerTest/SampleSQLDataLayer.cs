...
namespace BaseSQLDataLayerTest
{
  public class SampleSQLDataLayer : BaseSQLDataLayer
  {
    ...
    //TODO: still lots to be done
    // dataTables can be a mixed of different tables.
    // for demo purpose, assume there's only one type "lines"
    ...
    public override System.Data.DataTable GetDataTable(string tableName, string whereClause, int start, int limit)
    {
      throw new NotImplementedException();
    }
