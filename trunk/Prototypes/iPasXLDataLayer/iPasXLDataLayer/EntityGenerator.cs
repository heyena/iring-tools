...
namespace Hatch.iPasXLDataLayer.API
{
  public class EntityGenerator
  {
    ...
    public Response Generate(string filePath, string projectName, string applicationName)
    {
      ...
      if (iPasXLConfig.Worksheets != null)
      {
        ...
        try
        {
          ...
          Utility.Write<iPasXLConfiguration>(iPasXLConfig, _settings["XmlPath"] + "iPasXL." + projectName + "." + applicationName + ".xml", true);          
          Utility.WriteString(sourceCode, _settings["CodePath"] + "Model." + projectName + "." + applicationName + ".cs", Encoding.ASCII);
          DataDictionary dataDictionary = CreateDataDictionary(iPasXLConfig);
    ...
    private DataDictionary CreateDataDictionary(iPasXLConfiguration iPasXLConfig)
    {
