...
<html xmlns="http://www.w3.org/1999/xhtml" >
  ...
  <body>
    ...
    <div class="main">
      ...
      <ul>
		<li><a href="SPARQLQuery.aspx">SPARQL Query</a></li>
		<li><a href="RefDataEditor.aspx">Reference Data Editor</a></li>
		<li><a href="AppEditor.aspx">Application Editor</a></li>
    <li><a href="MappingEditor.aspx">Mapping Editor</a></li>
	  </ul>
    </div>
  </body>
</html>
