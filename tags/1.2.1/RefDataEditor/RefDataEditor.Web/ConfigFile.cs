...
public static class ConfigFile
{
    ...
    {
        // Get dictionary list of all items in Web.Config's 
        // AppSettings and ConnectionString
        IDictionary<string, string> configList =
            filePath.GetSection(ConfigFile.AppSettings,
                filePath.GetSection(ConfigFile.ConnectionString));
