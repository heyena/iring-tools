...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost/ext-3.2.1/resources/css/ext-all.css"/>

    <!-- ExtJS library: base/adapter -->
    <script src="http://localhost/ext-3.2.1/adapter/ext/ext-base.js" type="text/javascript"></script>
    
    <!-- ExtJS library: all widgets -->
    <script src="http://localhost/ext-3.2.1/ext-all.js" type="text/javascript"></script>
    ...
    <script src="http://localhost/ext-3.2.1/ux/SearchField.js" type="text/javascript"></script>
