        ...
        try {
          ...
          if (dataType != null){          
            if (dataType == 'application'){
            	...
            	var app = baseUri.substring(lastSlash + 1, baseUri.length);
            	valString = baseUri.substring(0, lastSlash);
            	lastSlash = valString.lastIndexOf('/');            	
            	var scope = valString.substring(lastSlash + 1, valString.length);
            	lastSlash = valString.lastIndexOf('/');  
            	baseUri = valString.substring(0, lastSlash);
              ...
              loadPageDto('app', 'adata', context, label);
            	...
            	valString = properties['Name'];
            	lastSlash = valString.indexOf('.');
            	var scope = valString.substring(0, lastSlash);
