...
<html>
  ...
  <body>
    <div class="banner">
      <h1>
        <img src="img/iring-tools-logo.png" />&nbsp; Version 3.00.00
      </h1>
    </div>
    <div class="main">
      <p>
      ...
      <p>
        ...
        browse and extend ISO 15926 reference data, map an application schema to 
        the<br/>
        ...
        <tr valign=top>
          <td>
            ...
            <ul>
			  ...
			  <li>
                <a href="Apps/UserSecurityManager">
                User Security Manager</a>
              </li>
            </ul>
          </td>
          <td>
