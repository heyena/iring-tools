...
namespace org.iringtools.services
{
    ...
    public class ApplicationConfigurationService
    {
        ...
        public void GetNodesForCache(string nodeType, Guid nodeId, string userName, string format)
        {
         ...
         [Description("Get graph by application id")]
         [WebGet(UriTemplate = "/GetDataModeByDataObjectId?dataObjectId={dataObjectId}&format={format}")]
         public void GetDataModeByDataObjectId(Guid dataObjectId, string format)
         {
             try
             {
                 if (string.IsNullOrEmpty(format))
                 ...
                 string output = _applicationConfigurationProvider.GetDataModeByDataObjectId(dataObjectId);
         ...
         [Description("Insert valuelistmap to the data base.")]
         [WebInvoke(Method = "POST", UriTemplate = "/insertValueListMap?format={format}")]
         public void InsertValueListMap(string format, Stream stream)
         {
             if (string.IsNullOrEmpty(format))
             { format = "xml"; }
             ...
             try
             {
                 ...
                 else
                 {
                     ...
                     response = _applicationConfigurationProvider.InsertValueListMap(new XDocument(xElement));
                 }
             }
             catch (Exception ex)
             {
                 CustomErrorLog objCustomErrorLog = new CustomErrorLog();
                 _CustomError = objCustomErrorLog.customErrorLogger(ErrorMessages.errAddValueListMap, ex, _logger);
                 objCustomErrorLog.throwJsonResponse(_CustomError);
             }
             PrepareResponse(ref response);
             _applicationConfigurationProvider.FormatOutgoingMessage<Response>(response, format, true);
         ...
         [Description("Update valuelistmap to the data base.")]
         [WebInvoke(Method = "PUT", UriTemplate = "/updateValueListMap?format={format}")]
         public void UpdateValueListMap(string format, Stream stream)
         {
             if (string.IsNullOrEmpty(format))
             { format = "xml"; }
             ...
             try
             {
                 ...
                 {
                     XElement xElement = _applicationConfigurationProvider.FormatIncomingMessage<ValueListMap>(stream, format);
                     response = _applicationConfigurationProvider.UpdateValueListMap(new XDocument(xElement));
                 }
             }
             catch (Exception ex)
             {
                 CustomErrorLog objCustomErrorLog = new CustomErrorLog();
                 _CustomError = objCustomErrorLog.customErrorLogger(ErrorMessages.errUpdateValueListMap, ex, _logger);
                 objCustomErrorLog.throwJsonResponse(_CustomError);
             }
             PrepareResponse(ref response);
             _applicationConfigurationProvider.FormatOutgoingMessage<Response>(response, format, true);
         ...
         [Description("Insert valuemap to the data base.")]
         [WebInvoke(Method = "POST", UriTemplate = "/insertValueMap?format={format}")]
         public void InsertValueMap(string format, Stream stream)
         {
             if (string.IsNullOrEmpty(format))
             { format = "xml"; }
             ...
             try
             {
                 ...
                 {
                     XElement xElement = _applicationConfigurationProvider.FormatIncomingMessage<ValueListMap>(stream, format);
                     response = _applicationConfigurationProvider.InsertValueMap(new XDocument(xElement));
                 }
             }
             catch (Exception ex)
             {
                 CustomErrorLog objCustomErrorLog = new CustomErrorLog();
                 _CustomError = objCustomErrorLog.customErrorLogger(ErrorMessages.errAddValueMap, ex, _logger);
                 objCustomErrorLog.throwJsonResponse(_CustomError);
             }
             PrepareResponse(ref response);
             _applicationConfigurationProvider.FormatOutgoingMessage<Response>(response, format, true);
