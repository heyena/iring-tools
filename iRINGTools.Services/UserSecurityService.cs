    ...
    public class UserSecurityService
    {
        ...
        public void GetGroupsByUser(string userName, string format)
        {
            try
            {
                ...
                Groups groups = _userSecurityProvider.GetGroupsByUser(userName);
                _userSecurityProvider.FormatOutgoingMessage<Groups>(groups, format, true);
            }
            catch (Exception ex)
            {
        ...
        [Description("Link groups with user to the database.")]
        [WebInvoke(Method = "POST", UriTemplate = "/insertUserGroups?format={format}")]
        public void InsertUserGroups(string format, Stream stream)
        {
            ...
            try
            {
                ...
                {
                    XElement xElement = _userSecurityProvider.FormatIncomingMessage<UserGroups>(stream, format);
                    response = _userSecurityProvider.InsertUserGroups(new XDocument(xElement));
                }
            }
            catch (Exception ex)
            {
        ...
        [Description("Return all groups belongs role to from the database.")]
        [WebGet(UriTemplate = "/roleGroups?roleId={roleId}&format={format}")]
        public void GetRoleGroups(int roleId, string format)
        {
            try
            {
                if (string.IsNullOrEmpty(format))
        ...
        [Description("Link groups with role to the database.")]
        [WebInvoke(Method = "POST", UriTemplate = "/insertRoleGroups?format={format}")]
        public void InsertRoleGroups(string format, Stream stream)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    response = _userSecurityProvider.InsertRoleGroups(new XDocument(xElement));
                }
            }
            catch (Exception ex)
            {
        ...
        [Description("Link permissions with role to the database.")]
        [WebInvoke(Method = "POST", UriTemplate = "/insertRolePermissions?format={format}")]
        public void InsertRolePermissions(string format, Stream stream)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    response = _userSecurityProvider.InsertRolePermissions(new XDocument(xElement));
                }
            }
            catch (Exception ex)
            {
