...
//      }
  ...
  onShowCacheInfo: function () {
    var that = this;

    var cacheInfoPanel = new AdapterManager.CacheInfoPanel({
      title: 'Cache Information',
      node: this.directoryPanel.getSelectionModel().getSelectedNode()
    });

//    cacheInfoPanel.on('refreshComplete', function () {
//      cacheInfoPanel.close();
//      that.onReload();
//    }, this);

//    cacheInfoPanel.on('importComplete', function () {
//      cacheInfoPanel.close();
//      that.onReload();
//    }, this);

    cacheInfoPanel.display();
  },
