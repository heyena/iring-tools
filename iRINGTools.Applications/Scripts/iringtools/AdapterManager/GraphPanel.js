                ...
                var classdd = new Ext.dd.DropTarget(classTarget, {
                    ...
                    notifyDrop: function (classdd, e, data) {
                        if (data.node.attributes.type != 'ClassNode') {
                            ...
                            var lbl = (data.node.attributes.record.Label != undefined) ? data.node.attributes.record.Label : data.node.attributes.record.label;
                            thisform.getForm().findField('classLabel').setValue(lbl);
