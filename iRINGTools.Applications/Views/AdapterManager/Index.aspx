...
<head id="Head1" runat="server">
    ...
    <script src="<%: Url.Content("~/Scripts/adaptermanager/ux/GridPageSizer.js") %>" type="text/javascript"></script>
...
<body>
    <div id="header" class="exchangeBanner">
        <span style="float: left">
            <img alt="q" src="<%: Url.Content("~/Content/img/iRINGTools_logo.png") %>" style="margin: 0 0 0 11px;
                vertical-align: -20%" />
            <span style="margin: 0 0 0 6px;"><font size="5px" style="font-family: Arial, Helvetica, Sans-Serif">
                Adapter Manager</font></span> </span><span style="float: right; margin: 18px 36px 1px 0">
                    <a href="http://iringug.org/wiki/index.php?title=IRINGTools" target="_blank" class="headerLnkBlack">
                        Help</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id="about-link" href="#" class="headerLnkBlack">About</a>
                </span>
    </div>
</body>
</html>
