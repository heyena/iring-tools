...
{
  public abstract class SPPIDObject
  {
...
namespace Bechtel.SPPIDDataLayer.Model
{  
  public class Equipment : SPPIDObject
  {
    public Equipment()
    {
  ...
  public class Instrument : SPPIDObject
  {
    public Instrument()
    {
  ...
  public class PipeRun : SPPIDObject
  {
    public PipeRun()
    {
  ...
  public class PipingComp : SPPIDObject
  {
    public PipingComp()
    {
